...
function normalizeTripConfig(raw = {}) {
  ...
  return {
    ...
    flight: {
      ...
      preferredCarriers: asString(
        flight.preferredCarriers,
        DEFAULT_TRIP_CONFIG.flight.preferredCarriers
      ).toUpperCase(),
      maxStops:
        flight.maxStops === "" || flight.maxStops == null
          ? ""
          : String(asNumber(flight.maxStops, 0)),
      maxDurationMinutes:
        flight.maxDurationMinutes === "" || flight.maxDurationMinutes == null
          ? ""
          : String(asNumber(flight.maxDurationMinutes, 0)),
    },
    alerts: {
